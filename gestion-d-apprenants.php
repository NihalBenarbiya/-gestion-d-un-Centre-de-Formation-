...
$page = [
    "title"=>"Apprenants",
    "url_path"=>"gestion-des-apprenants.php",
];
?>
<!DOCTYPE html>
<html lang="fr">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="">Formations</th>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="form_control_MDP" onchange="handleChange(this, 'MDP')"/>
                        </div>
                    </div>
...
<script src="assets/js/pages/gestion-d-apprenants.js"></script>
</body>
